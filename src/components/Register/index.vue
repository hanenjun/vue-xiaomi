    ...
    <dir class="content">
      ...
      <h1>注册小米账号</h1>
        ...
        <div class="codes">
          ...
          <button v-if="!loginw" @click="send">发送验证码</button>
        </div>
        <button v-if="!loginw" @click="goto">下一步</button>
        <button v-if="loginw" @click="login">注册</button>
      </div>
    </dir>
       <el-dialog title="注册" :visible.sync="register" width="30%">
      <h3>请填写正确的手机号</h3>
    </el-dialog>
  </div>
</template>
